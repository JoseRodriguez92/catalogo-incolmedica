export default function HeroBanner() {
  return (
    <section className="bg-gradient-to-br from-blue-700 via-blue-600 to-cyan-500 text-white overflow-hidden pt-24 md:pt-28">
        ...
        <div className="flex-1 space-y-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <p className="text-blue-100 text-sm max-w-xs leading-relaxed">
              En equipos médicos y de diagnóstico seleccionados. Solo hasta
              agotar existencias.
            </p>
          </div>
