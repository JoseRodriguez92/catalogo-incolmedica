...
export default function ContactForm() {
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-10 flex flex-col items-center justify-center text-center gap-5 min-h-[400px]">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm leading-relaxed max-w-sm">
            Gracias por contactarnos. Un asesor de Incolmedica se comunicará contigo en las próximas horas.
          </p>
        </div>
        <button
  ...
  return (
    <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
      <h2 className="text-xl font-black text-gray-800 mb-1">Completa el formulario</h2>
      <p className="text-sm text-gray-400 mb-7">Todos los campos son obligatorios.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm text-gray-400 font-medium">+57</span>
              <input
                type="tel"
                required
        ...
        <label className="flex items-start gap-3 cursor-pointer group">
          <input type="checkbox" required className="mt-0.5 rounded border-gray-300 text-blue-600 focus:ring-blue-500 flex-shrink-0" />
          <span className="text-xs text-gray-400 leading-relaxed">
            Acepto que Incolmedica utilice mis datos de contacto para responder a esta solicitud, de acuerdo con su política de privacidad.
          </span>
        </label>
