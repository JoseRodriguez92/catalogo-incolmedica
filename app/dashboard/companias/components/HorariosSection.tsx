        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              {horarios.length} horario{horarios.length !== 1 ? "s" : ""} configurado
              {horarios.length !== 1 ? "s" : ""}
            </p>
          </div>
        </div>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-md text-xs font-semibold transition-all ${
                  horarioViewMode === "grouped"
                    ? "bg-white text-incolmedica-primary shadow-sm"
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  {hd ? (
                    <div className="flex items-center gap-4 flex-1">
                      <div className={`flex items-center gap-2 px-3 py-1.5 rounded-lg ${hd.activo ? "bg-white shadow-sm" : "bg-gray-100"}`}>
                        <svg className={`w-4 h-4 ${hd.activo ? "text-incolmedica-primary" : "text-gray-400"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
